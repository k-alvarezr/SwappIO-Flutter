...
class DropoffMapView extends StatelessWidget {
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              ...
                              child: const Stack(
                                children: [
                                  Positioned(top: 70, left: 90, child: Icon(Icons.place_rounded, color: AppColorsView.primary, size: 36)),
                                  Positioned(top: 120, right: 100, child: Icon(Icons.place_rounded, color: AppColorsView.primary, size: 36)),
                                  Positioned(bottom: 80, left: 140, child: Icon(Icons.place_rounded, color: AppColorsView.primary, size: 36)),
                                ],
                              ),
                            ),
                          ),
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  ...
                                  child: Row(
                                    children: [
                                      const CircleAvatar(backgroundColor: Color(0x1A077288), child: Icon(Icons.place_rounded, color: AppColorsView.primary)),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(point.address, style: const TextStyle(fontSize: 12, color: AppColorsView.textMuted)),
                                            const SizedBox(height: 4),
                                            Text('${point.opensAt} - ${point.closesAt}', style: const TextStyle(fontSize: 12, color: AppColorsView.primary)),
                                          ],
                                        ),
                                      ),
                                    ],
