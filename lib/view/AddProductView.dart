...
// Nuevo método para el botón de ubicación actual
  Future<void> _getCurrentLocation() async {
    ...
    _onMapTapped(LatLng(position.latitude, position.longitude));
  }
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: GoogleMap(
                                          initialCameraPosition: CameraPosition(
                                            target: LatLng(_selectedLatitude ?? 4.6097, _selectedLongitude ?? -74.0817),
                                            zoom: 14,
                                          ),
                                          onTap: _onMapTapped,
                                          myLocationEnabled: true,
                                          myLocationButtonEnabled: false,
                                          markers: _selectedLatitude != null
                                              ? {
                                            Marker(
