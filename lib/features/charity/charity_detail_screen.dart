...
class CharityDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final charityRepository = AppServices.instance.charityRepository;

    return FutureBuilder<Charity>(
      future: charityRepository.getCharityById(charityId),
                ...
                children: [
                  ...
                  _InfoCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(charity.description, style: const TextStyle(color: AppColors.textMuted, height: 1.4)),
                        const SizedBox(height: 12),
                        const Row(
                          children: [
                            Text('Read full report', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w700)),
                            SizedBox(width: 4),
                  ...
                  _InfoCard(
                    ...
                    trailing: TextButton(
                      onPressed: () => Navigator.of(context).pushNamed(AppRoutes.dropOffMap),
                    ...
                    child: const Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        _DropoffPreview(title: 'Centro de Acopio Usaquén', address: 'Carrera 7 #119-14', status: 'Closes 5pm', distance: '4.2 km away'),
                      ],
                    ),
                  ),
                  const SizedBox(height: 18),
...
class _HeroSection extends StatelessWidget {
  const _HeroSection({required this.charity});
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: const Text('Verified Nonprofit', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w600)),
        ),
        const SizedBox(height: 10),
        Text(charity.impact, textAlign: TextAlign.center, style: const TextStyle(color: AppColors.textMuted, height: 1.4)),
        const SizedBox(height: 16),
        ElevatedButton.icon(onPressed: () {}, icon: const Icon(Icons.favorite_rounded), label: const Text('Donate Clothes Now')),
      ],
    );
  }
}
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 2),
                Text(address, style: const TextStyle(fontSize: 12, color: AppColors.textMuted)),
...
class _ContactRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        CircleAvatar(backgroundColor: AppColors.primary.withOpacity(0.12), child: Icon(icon, size: 18, color: AppColors.primary)),
